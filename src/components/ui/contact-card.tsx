...
export function ContactCard({
	...
	return (
		<div
			...
			{...props}
		>
			<PlusIcon className="hidden sm:block absolute -top-3 -left-3 h-6 w-6" />
			<PlusIcon className="hidden sm:block absolute -top-3 -right-3 h-6 w-6" />
			<PlusIcon className="hidden sm:block absolute -bottom-3 -left-3 h-6 w-6" />
			<PlusIcon className="hidden sm:block absolute -right-3 -bottom-3 h-6 w-6" />
